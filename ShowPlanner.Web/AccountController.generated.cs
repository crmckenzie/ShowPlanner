...
namespace ShowPlanner.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : ShowPlanner.Web.Controllers.AccountController
    {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ShowPlanner.Web.Models.LoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult Login(ShowPlanner.Web.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ShowPlanner.Web.Models.RegisterModel model);

        public override System.Web.Mvc.ActionResult Register(ShowPlanner.Web.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ShowPlanner.Web.Controllers.AccountController.ManageMessageId? message);

        public override System.Web.Mvc.ActionResult Manage(ShowPlanner.Web.Controllers.AccountController.ManageMessageId? message)
        {
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ShowPlanner.Web.Models.LocalPasswordModel model);

        public override System.Web.Mvc.ActionResult Manage(ShowPlanner.Web.Models.LocalPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, ShowPlanner.Web.Models.RegisterExternalLoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(ShowPlanner.Web.Models.RegisterExternalLoginModel model, string returnUrl)
        {
